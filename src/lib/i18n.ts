...
export const TRANSLATIONS = {
  sr: {
    ...
    'about.plan.v1.2': '9-koračni vodič + pretraga (radi i na latinici i na ćirilici)',
    'about.plan.v1.3': 'Snimanje rezultata kao PDF, instalacija na telefon kao aplikacija',
    ...
    'about.plan.v15.5': 'AI sloj koji objašnjava prava na osnovu tvoje konkretne situacije i vodi te kroz proces',
    'about.plan.v15.6': 'Kalkulatori za prava sa promenljivim iznosima (dečji dodatak, MOP, energetski dodatak - uneseš podatke, vidiš tačan iznos)',
    'about.plan.v15.7': 'Opcionalni podsetnici za rokove (npr. obnova prava, žalba) - bez čuvanja kontakta kod nas',
    'about.plan.v15.8': 'Štampana brošura za starije i one bez interneta (PDF + saradnja sa domovima penzionera i mesnim zajednicama)',
    'about.plan.v2.title': 'V2 - kad budu sponzori',
    'about.plan.v2.1': 'Konkursni feed (automatsko prikupljanje javnih poziva sa privreda.gov.rs, NSZ, RAS)',
    ...
    'about.plan.v2.4': 'Mobilna aplikacija (Android prvi, iOS posle)',
    'about.plan.v2.5': 'Automatsko popunjavanje formulara (uz pravnu validaciju i eksplicitnu saglasnost korisnika)',
    'about.plan.v2.6': 'Mreža volontera koji pomažu starijima i nepismenima da podnesu zahtev na šalteru',
    'about.plan.v2.7': 'Direktna integracija sa eUpravom kad bude javni API (popunjavaš zahtev iz aplikacije)',
    'about.plan.v2.8': 'Telefonska linija za pitanja (uz NGO partnere - 2-3 sata dnevno, ne 24/7)',
    'about.plan.cont.title': 'Stalno (paralelno)',
    'about.plan.cont.1': 'Iscrpno mapiranje svih državnih prava (cilj: 200+ do V2)',
    'about.plan.cont.2': 'Redovne provere i ažuriranja svakog prava posle izmena zakona ili podzakonskih akata',
    'about.plan.cont.3': 'Sakupljanje pitanja i prijava korisnika kao osnov za ispravke i nove unose u katalogu',
    'about.plan.cont.4': 'Edukativne radionice u opštinama, NGO prostorima i domovima penzionera',
    'about.plan.cont.5': 'Saradnja sa medijima za podizanje svesti i destigmatizaciju traženja pomoći',
    'about.plan.cont.6': 'Saradnja sa centrima za socijalni rad da informacije stignu i do najugroženijih',
    'about.plan.cont.7': 'Otvorene konsultacije sa pravnicima i pravnim klinikama (Pravosudna akademija, fakulteti)',
  ...
  en: {
    ...
    'about.plan.v1.2': '9-step guide + search (works in both Latin and Cyrillic)',
    'about.plan.v1.3': 'Save results as PDF, install on phone as an app',
    ...
    'about.plan.v15.5': 'AI layer that explains rights based on your specific situation and walks you through the process',
    'about.plan.v15.6': 'Calculators for rights with variable amounts (child allowance, MOP, energy aid - enter inputs, see your exact amount)',
    'about.plan.v15.7': 'Optional deadline reminders (e.g. renewals, appeals) - no contact info stored on our side',
    'about.plan.v15.8': 'Printed brochure for the elderly and offline users (PDF + distribution via retiree homes and local councils)',
    'about.plan.v2.title': 'V2 - when sponsors arrive',
    'about.plan.v2.1': 'Public calls feed (automatic collection from privreda.gov.rs, NSZ, RAS)',
    ...
    'about.plan.v2.4': 'Mobile app (Android first, iOS later)',
    'about.plan.v2.5': 'Automated form filling (with legal validation and explicit user consent)',
    'about.plan.v2.6': 'A volunteer network that helps the elderly and the illiterate file requests at counters',
    'about.plan.v2.7': 'Direct integration with eUprava once a public API exists (file requests right from the app)',
    'about.plan.v2.8': 'Phone line for questions (with NGO partners - 2-3 hours per day, not 24/7)',
    'about.plan.cont.title': 'Continuous (in parallel)',
    'about.plan.cont.1': 'Exhaustive mapping of all state benefits (target: 200+ by V2)',
    'about.plan.cont.2': 'Regular checks and updates of every right after legal or sub-legal changes',
    'about.plan.cont.3': 'Collecting user questions and reports as the basis for catalog corrections and additions',
    'about.plan.cont.4': 'Education workshops at municipalities, NGO venues, and retiree homes',
    'about.plan.cont.5': 'Media partnerships to raise awareness and destigmatize asking for help',
    'about.plan.cont.6': 'Cooperation with social work centers so information reaches the most vulnerable',
    'about.plan.cont.7': 'Open consultations with lawyers and legal clinics (Judicial Academy, law faculties)',
