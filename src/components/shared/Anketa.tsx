...
export function Anketa() {
  ...
  if (answered) {
    return (
      <section className="mt-12 rounded-md border border-[#dfe1e2] bg-white p-6 text-center">
        <h3 className="text-[16px] font-bold text-[#162e51]">Hvala vam!</h3>
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-3">
          <button
            ...
            className="rounded-md border border-[#162e51] px-4 py-2 text-[13.5px] font-semibold text-[#162e51] hover:bg-[#162e51] hover:text-white"
          >
            Podeli sa drugima
          </button>
          <Link
            ...
            className="rounded-md bg-[#162e51] px-4 py-2 text-[13.5px] font-semibold text-white hover:bg-[#0b1f3f]"
          >
            Podržite projekat
          </Link>
        </div>
  ...
  return (
    <section className="mt-12 rounded-md border border-[#dfe1e2] bg-white p-6">
      <h3 className="text-[16px] font-bold text-[#162e51]">
      ...
      <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
        {ANSWERS.map((a) => (
          <button
            ...
            className="rounded-md border border-[#dfe1e2] bg-white px-4 py-2.5 text-left text-[14px] font-medium text-[#1b1b1b] transition-colors hover:border-[#162e51] hover:bg-[#162e51]/5"
          >
            {a.label}
          </button>
        ))}
