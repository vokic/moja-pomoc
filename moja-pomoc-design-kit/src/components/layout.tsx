    ...
    <div className="flex items-center gap-0">
      {(["usa", "srpski"] as Theme[]).map((t, i) => (
        <button
          ...
          style={theme === t ? { color: t === "usa" ? "#162e51" : "#1B3A6B", backgroundColor: t === "usa" ? "#162e51" : "#1B3A6B" } : undefined}
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-6 py-3">
          <Link to="/" className="flex items-center gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#162e51]">
              <span className="text-[11px] font-black leading-none text-white" style={{ fontFamily: "Merriweather, serif" }}>
                мп
              </span>
            </span>
            <span className="leading-tight">
              <span className="block text-[16px] font-bold text-[#162e51]">Moja Pomoć</span>
              <span className="hidden text-[11.5px] text-[#565c65] sm:block">Vodič kroz prava i naknade u Srbiji</span>
            </span>
          </Link>
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
            <div>
              <div className="flex items-center gap-3">
                <span className="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                  <span className="text-[12px] font-black leading-none text-[#162e51]" style={{ fontFamily: "Merriweather, serif" }}>
                    мп
                  </span>
                </span>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-[14px] text-white/85">
                <li><Link to="/wizard" className="hover:text-white hover:underline">Pokrenite vodič</Link></li>
                <li><Link to="/pretraga" className="hover:text-white hover:underline">Sve pomoći i naknade</Link></li>
                <li><Link to="/rezultati" className="hover:text-white hover:underline">Moji rezultati</Link></li>
                <li><Link to="/o-projektu" className="hover:text-white hover:underline">O projektu</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-[15px] font-bold">Zvanične institucije</h4>
              <ul className="mt-3 space-y-2 text-[14px] text-white/85">
                <li><a href="https://euprava.gov.rs" target="_blank" rel="noreferrer" className="hover:text-white hover:underline">eUprava ↗</a></li>
                <li><a href="https://www.pio.rs" target="_blank" rel="noreferrer" className="hover:text-white hover:underline">PIO fond ↗</a></li>
                <li><a href="https://www.rfzo.rs" target="_blank" rel="noreferrer" className="hover:text-white hover:underline">RFZO ↗</a></li>
                <li><a href="https://www.nsz.gov.rs" target="_blank" rel="noreferrer" className="hover:text-white hover:underline">NSZ ↗</a></li>
              </ul>
            </div>
            <div>
  ...
  return (
    <header style={{ fontFamily: '"PT Sans", system-ui, sans-serif' }}>
      ...
      <div className="bg-[#0A1A33] text-[12.5px] text-white/85">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-2 px-6 py-1.5">
          <span style={{ fontFamily: '"PT Sans Caption", sans-serif' }} className="font-bold uppercase tracking-wider">
      ...
      <div className="border-b border-[#D5DCE3] bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-6 py-5">
          <Link to="/" className="flex items-center gap-4">
            <span className="flex h-14 w-14 shrink-0 items-center justify-center bg-[#1B3A6B]" style={{ clipPath: "polygon(50% 0%, 100% 30%, 100% 75%, 50% 100%, 0% 75%, 0% 30%)" }}>
              <span className="text-[14px] font-bold leading-none text-white" style={{ fontFamily: '"PT Sans Caption", sans-serif' }}>
                МП
              </span>
            </span>
            <span className="leading-tight">
              <span className="block text-[20px] font-bold text-[#0F2547]" style={{ fontFamily: '"PT Sans Caption", sans-serif' }}>
                Moja Pomoć
              </span>
              <span className="block text-[12px] text-[#565c65]">Republika Srbija · vodič kroz prava i naknade</span>
            </span>
          </Link>
      ...
      <div className="bg-[#0A1A33] text-white">
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
            <div>
              <div className="flex items-center gap-3">
                <span className="flex h-12 w-12 items-center justify-center bg-[#1B3A6B]" style={{ clipPath: "polygon(50% 0%, 100% 30%, 100% 75%, 50% 100%, 0% 75%, 0% 30%)" }}>
                  <span className="text-[12px] font-bold leading-none text-white" style={{ fontFamily: '"PT Sans Caption", sans-serif' }}>
                    МП
                  </span>
                </span>
                <span className="text-lg font-bold" style={{ fontFamily: '"PT Sans Caption", sans-serif' }}>
                  Moja Pomoć
                </span>
              </div>
            ...
            <div>
              <h4 className="text-[14px] font-bold uppercase tracking-wider text-white" style={{ fontFamily: '"PT Sans Caption", sans-serif' }}>
                Brzi linkovi
              </h4>
